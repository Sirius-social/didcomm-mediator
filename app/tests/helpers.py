...
from app.db.models import users, agents, pairwises, endpoints, routing_keys, global_settings
...
async def allocate_test_database():
    ...
    metadata.create_all(test_engine, tables=[users, agents, pairwises, endpoints, routing_keys, global_settings])
